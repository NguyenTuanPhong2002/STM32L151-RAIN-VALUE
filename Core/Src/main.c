...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, PWR_Pin | RST_SIM_Pin | FLIGHT_Pin | PWRKEY_Pin | DC_Pin | RST_Pin | CS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : BT2_Pin BT3_Pin BT4_Pin BT5_Pin
                           BT6_Pin BT7_Pin */
  GPIO_InitStruct.Pin = BT2_Pin | BT3_Pin | BT4_Pin | BT5_Pin | BT6_Pin | BT7_Pin;
  ...
  GPIO_InitStruct.Pin = PWR_Pin | RST_SIM_Pin | FLIGHT_Pin | PWRKEY_Pin | DC_Pin | RST_Pin | CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
